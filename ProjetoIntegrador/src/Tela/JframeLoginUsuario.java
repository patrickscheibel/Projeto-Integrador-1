...
public class JframeLoginUsuario extends javax.swing.JFrame {
    ...
    private void jButtonSelecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSelecionarActionPerformed
        ...
        //remover o if
        if(usuario != null){
            JIFrameTelaPrincipal jf = new JIFrameTelaPrincipal(usuario);
            this.dispose();
            jf.setVisible(true);
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JIFrameTelaPrincipal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
